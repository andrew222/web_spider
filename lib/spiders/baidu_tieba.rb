      ...
      until page_url.nil?
        ...
        post_elems.reverse.each do |post_elem|
          ...
          if author.save
            ...
            post.save
            new_posts << {title: article.title, author_name: author.name, author_link: author.author_home_link, post_content: post.content, post_link: post.post_link, posted_at: post.posted_at.localtime}
          end
        end
